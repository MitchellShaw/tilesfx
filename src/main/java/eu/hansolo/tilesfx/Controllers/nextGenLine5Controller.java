...
public class nextGenLine5Controller implements Initializable
{
    double sevenGoal;
    double eightGoal;
    double nineGoal;
    ...
    private void createTable()
    {
        ...
        double actualGoal = messenger.getMainBuildController().getRetailBar1Goal()/5;
    ...
    private void tableRefresh() {
        ...
        {
            if(timeOrbs.get(i).getLine().equals("MIDLAND.POS_NG5"))
            {
                index = i;
                break;
            }
        ...
        for(int i = 0; i<orbList.size();i++)
        {
            ...
            switch(header)
            {
                ...
                case "5":
                    ...
                    break;
                case "Total":
                    orbList.get(i).setGoal(messenger.getMainBuildController().getRetailBar1Goal()/5);

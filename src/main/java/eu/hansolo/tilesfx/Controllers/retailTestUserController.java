...
public class retailTestUserController extends Controller implements Initializable,Methods {
    private Tile logo;
    private Tile clock;
    private Tile dept;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        dept = TileBuilder.create()
                ...
                .titleAlignment(TextAlignment.CENTER)
                .roundedCorners(false)
                .title("Retail Total Tested")
                .description(Double.toString(testController.getRetailTotalCurrentTest()))
                .build();

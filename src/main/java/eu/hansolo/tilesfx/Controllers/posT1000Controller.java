...
public class posT1000Controller implements Initializable
{
    double sevenGoal;
    double eightGoal;
    double nineGoal;
    ...
    private void createTable()
    {
        ...
        double actualGoal = messenger.getMainBuildController().getT1000sGoalBuild();
    ...
    private void tableRefresh() {
        ...
        {
            if(timeOrbs.get(i).getLine().equals("MIDLAND.T1000"))
            {
                index = i;
                break;
            }
        ...
        for(int i = 0; i<orbList.size();i++)
        {
            ...
            switch(header)
            {
                ...
                case "5":
                    ...
                    break;
                case "Total":
                    orbList.get(i).setGoal(messenger.getMainBuildController().getT1000sGoalBuild());

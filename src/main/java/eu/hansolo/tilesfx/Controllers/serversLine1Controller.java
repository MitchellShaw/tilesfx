...
public class serversLine1Controller implements Initializable
{
    ...
    {
        buildTable.setFixedCellSize(messenger.getResolutionizer().screenHeight/12.8);
    ...
    private void tableRefresh() {
        ...
        {
            if(timeOrbs.get(i).getLine().equals("MIDLAND.SERVERS"))
            {
                index = i;
                break;
            }
        ...
        for(int i = 0; i<orbList.size();i++)
        {
            ...
            switch(header)
            {
                ...
                case "5":
                    ...
                    break;
                case "Total":
                    orbList.get(i).setGoal(messenger.getMainBuildController().getServerBar1Goal());

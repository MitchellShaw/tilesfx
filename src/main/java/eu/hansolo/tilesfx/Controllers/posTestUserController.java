...
public class posTestUserController extends Controller implements Initializable,Methods {
    private Tile logo;
    private Tile clock;
    private Tile dept;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        dept = TileBuilder.create()
                ...
                .titleAlignment(TextAlignment.CENTER)
                .roundedCorners(false)
                .title("POS Total Tested")
                .description(Double.toString(testController.getPosTotalCurrentTest()))
                .build();

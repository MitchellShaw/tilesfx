...
public class opticLine2Controller implements Initializable
{
    double sevenGoal;
    double eightGoal;
    double nineGoal;
    ...
    private void createTable()
    {
        ...
        double actualGoal = messenger.getMainBuildController().getOpticGoalTotalBuild()/4;
    ...
    private void tableRefresh() {
        ...
        {
            if(timeOrbs.get(i).getLine().equals("MIDLAND.OPTIC_2"))
            {
                index = i;
                break;
            }
        ...
        for(int i = 0; i<orbList.size();i++)
        {
            ...
            switch(header)
            {
                ...
                case "5":
                    ...
                    break;
                case "Total":
                    orbList.get(i).setGoal(messenger.getMainBuildController().getOpticGoalTotalBuild()/4);

...
public class periphLine2Controller implements Initializable
{
    double sevenGoal;
    double eightGoal;
    double nineGoal;
    ...
    private void createTable()
    {
        ...
        double actualGoal = messenger.getMainBuildController().getPeriphBar3Goal();
    ...
    private void tableRefresh() {
        ...
        {
            if(timeOrbs.get(i).getLine().equals("MIDLAND.ED_B"))
            {
                index = i;
                break;
            }
        ...
        double actualGoal = messenger.getMainBuildController().getServerBar1Goal();
        ...
        for(int i = 0; i<orbList.size();i++)
        {
            ...
            switch(header)
            {
                ...
                case "5":
                    ...
                    break;
                case "Total":
                    orbList.get(i).setGoal(messenger.getMainBuildController().getPeriphBar3Goal());

...
public class nextGenDisplayLineController implements Initializable
{
    double sevenGoal;
    double eightGoal;
    double nineGoal;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        Rectangle coverUp = new Rectangle();
        ...
        coverUp.setHeight(table.getPrefHeight());
        coverUp.setWidth(table.getPrefWidth());
        coverUp.setX(table.getLayoutX());
        coverUp.setY(table.getLayoutY());
        coverUp.setFill(TRANSPARENT);
    ...
    private void createTable()
    {
        ...
        System.out.println(differential.getPrefWidth());

        double actualGoal = messenger.getMainBuildController().getNextGenDisplayGoalsBuild();
    ...
    private void tableRefresh() {
        ...
        {
            if(timeOrbs.get(i).getLine().equals("MIDLAND.DISPLAY_NG1"))
            {
                index = i;
                break;
            }
        ...
        for(int i = 0; i<orbList.size();i++)
        {
            ...
            switch(header)
            {
                ...
                case "5":
                    ...
                    break;
                case "Total":
                    orbList.get(i).setGoal(messenger.getMainBuildController().getNextGenDisplayGoalsBuild());
